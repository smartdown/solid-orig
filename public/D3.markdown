...
The source for this [Smartdown](https://smartdown.io) card is available at https://smartdown.solid.community/public/D3.markdown and (*soon*) via [GitHub](https://github.com/smartdown/solid/site/D3.markdown).
